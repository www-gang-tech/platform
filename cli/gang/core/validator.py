...
class ContractValidator:
    ...
    def _has_contract_rule(self, section: str, rule: str) -> bool:
        """Return whether a configured contract section includes a rule."""
    ...
    def check_accessibility(self, html: str) -> List[Dict]:
        ...
        if self._has_contract_rule('accessibility', 'color_contrast'):
        ...
        if self._has_contract_rule('accessibility', 'keyboard_nav'):
    ...
    def check_seo(self, html: str) -> List[Dict]:
        ...
        if self._has_contract_rule('seo', 'meta_description'):
        ...
        # Check canonical URL
        if self._has_contract_rule('seo', 'canonical_url'):
        ...
        # Check valid JSON-LD
        if self._has_contract_rule('seo', 'valid_jsonld'):

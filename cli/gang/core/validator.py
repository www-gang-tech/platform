...
class ContractValidator:
    ...
    def check_budgets(self, html_path: Path) -> List[Dict]:
        ...
        if js_budget == 0 and not self._is_interactive_utility(html_path):
    ...
    def _is_interactive_utility(self, html_path: Path) -> bool:
        parts = set(html_path.parts)
        return bool(parts & {'search', 'cart', 'products', 'studio'})

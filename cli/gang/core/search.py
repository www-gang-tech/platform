...
class SearchIndexer:
    ...
    def _index_file(self, file_path: Path) -> Dict[str, Any]:
        ...
        return {
            ...
            'date': self._stringify_value(frontmatter.get('date', '')),
        }

    def _normalize_tags(self, tags: Any) -> List[str]:
        """Normalize tag frontmatter into a list of strings for indexing."""
        if tags is None:
            return []
    ...
    def _stringify_value(self, value: Any) -> str:
        """Make frontmatter scalar values JSON-serializable."""
        if value is None:
            return ''

...
class SearchIndexer:
    ...
    def _index_file(self, file_path: Path) -> Dict[str, Any]:
        ...
        return {
            ...
            'date': self._serialize_frontmatter_value(frontmatter.get('date', '')),
        }
    
    def _serialize_frontmatter_value(self, value: Any) -> Any:
        """Return a JSON-safe representation of common YAML frontmatter values."""

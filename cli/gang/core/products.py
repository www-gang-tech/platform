...
class ProductAggregator:
    ...
    def fetch_all(self) -> Dict[str, List[Dict[str, Any]]]:
        ...
        has_products = any(products_for_source for products_for_source in products.values())
        if has_products or attempted_live_fetch or self.config.get('demo_mode', False):

        ...
        for file_path in content_files:
            try:
                ...
                item = {
                    ...
                    'category': category,
                    'slug': slug,
                    'summary': str(frontmatter.get('summary', frontmatter.get('description', ''))),
                    'date': str(frontmatter.get('date', '')),
                    'tags': [str(tag) for tag in frontmatter.get('tags', [])] if isinstance(frontmatter.get('tags', []), list) else [str(frontmatter.get('tags'))] if frontmatter.get('tags') else []
                }
